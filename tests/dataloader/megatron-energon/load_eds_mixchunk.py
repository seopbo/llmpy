...
def get_args():
    ...
    parser.add_argument(
        "--blending_config_path",
        type=str,
        default="./blending_mixchunk.yaml",
    )
...
def main():
    ...
    for idx, batch in enumerate(train_dl):
        ...
        print(tokenizer.convert_tokens_to_string(tokenizer.convert_ids_to_tokens(input_ids[0])))
